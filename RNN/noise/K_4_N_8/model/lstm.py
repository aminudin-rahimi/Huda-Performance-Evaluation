...
for ratio_index in range(len(train_ratio)):
    for tr_snr_index in range(len(train_snr)):
        train_filename = 'ratio_' + str(train_ratio[ratio_index]) + '_train_snr_' + str(
            train_snr[tr_snr_index]) + 'dB.mat'
...
sio.savemat('../../../../Results/Result-with-noise/LSTM_Result/K_4_N_8/lstm_result',
