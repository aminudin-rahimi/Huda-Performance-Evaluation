...
result = sio.loadmat('../../../../Results/Result-with-noise/LSTM_Result/K_4_N_8/lstm_result.mat')
...
plt.figure()
for i in range(len(train_ratio)):
    plt.semilogy(test_snr, res_ber[i, int(best_train_snr_index[i]), :, -1].flatten(), line_style_1[i], lw=3)
...
plt.savefig('../../../../Results/Result-with-noise/LSTM_Result/K_4_N_8/ber.png')
# Show
plt.show()
